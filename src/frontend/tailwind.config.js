  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Custom clinic palette tokens
        forest: {
          DEFAULT: "oklch(var(--forest))",
          mid: "oklch(var(--forest-mid))",
      ...
      boxShadow: {
        ...
        card: "0 2px 16px 0 rgba(40, 80, 40, 0.08)",
        "card-hover": "0 8px 32px 0 rgba(40, 80, 40, 0.15)",
        leaf: "0 4px 24px 0 rgba(30, 90, 50, 0.12)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
